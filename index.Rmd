...
slides <- c(
  ...
  rep("<a class='fa fa-clock' href='https://giphy.com/embed/XIqCQx02E1U9W' target='_blank'></a>", 2)
)
...
recordings <- c(
  ...
  ,
   ...
   <a class='fa fa-youtube' href='https://unsw.sharepoint.com/sites/CLS-HDAT9700_T2_5226_10266/Shared%20Documents/General/Recordings/Meeting%20in%20_General_-20220718_170940-Meeting%20Recording.mp4?web=1' target='_blank'></a>"
  ,
     rep("<a class='fa fa-clock' href='https://giphy.com/embed/XIqCQx02E1U9W' target='_blank'></a>", 2))
)
...
df <- data.frame(
  ...
  link <- c(
    ...
    rep("<a class='fa fa-clock' href='https://media.giphy.com/media/XIqCQx02E1U9W/giphy.gif' target='_blank'></a>", 2)
  ),
