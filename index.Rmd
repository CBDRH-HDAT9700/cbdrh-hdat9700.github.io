...
slides <- c(
  ...
  rep("<a class='fa fa-clock' href='https://giphy.com/embed/XIqCQx02E1U9W' target='_blank'></a>", 3)
)
...
df <- data.frame(
  ...
  solution <- c(rep("<a class='fa fa-clock' href='https://media.giphy.com/media/XIqCQx02E1U9W/giphy.gif' target='_blank'></a>", 4))
